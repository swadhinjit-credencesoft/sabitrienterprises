...
import { CONTACT_EMAIL, WHATSAPP_NUMBER } from '../../data/navigation';
...
export default function BookingClient() {
  ...
  const emailHref = `mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('Booking / Enquiry Request — Sabitri Enterprises')}&body=${encodeURIComponent(message)}`;
